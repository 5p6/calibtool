...
public:
    ...
    std::vector<double>& cameraLefterror(void);
    const std::vector<double>& cameraLefterror(void) const;

    std::vector<double>& cameraRighterror(void);
    const std::vector<double>& cameraRighterror(void) const;
...
private:
    ...
    std::vector<double> cameraLeft_errors;
    std::vector<double> cameraRight_errors;
    bool m_verbose;
};
