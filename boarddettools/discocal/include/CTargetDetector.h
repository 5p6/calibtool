...
public:
    ...
    std::tuple<bool, vector<Shape>, vector<Shape>> DetectStereoCircle(cv::Mat &left_img, cv::Mat &right_img);
...
private:
    ...
    void drawshapes(cv::Mat &img_output,const pair<bool, vector<Shape>> &result);
    void visualize_result(cv::Mat &img_output, pair<bool, vector<Shape>> &result);
    void visualize_result(cv::Mat &left_output, cv::Mat& right_output, std::tuple<bool, vector<Shape>, vector<Shape>>& result);
